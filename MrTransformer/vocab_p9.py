...
class FreqVocab(object):
    ...
    def __init__(self, user_to_list):
        ...
        self.special_tokens = ["[Preference_1]","[Preference_2]","[Preference_3]","[Preference_4]",
                               "[Preference_5]","[Preference_6]","[Preference_7]","[Preference_8]","[Preference_9]"] #"[Preference_2]","[Preference_3]",
