...
if __name__ == "__main__":
    ...
    flags.DEFINE_string("data_dir", 'data/Yelp/', "data dir.")

    flags.DEFINE_string("dataset_name", 'Yelp', "dataset name.")
    ...
    # output_filename = output_dir + dataset_name + version_id + '.train_p1_learning1_faiss.tfrecord'
    # gen_samples(
    #     user_train_data,
    #     output_filename,
    #     rng,
