...
## Required parameters
flags.DEFINE_string(
    "bert_config_file", '../data/Amazon-sports/bert_config_sports_64_p9.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string(
    "train_input_file", '../data/Amazon-sports/sportsdefault.train_p9_learning1_faiss.tfrecord',
    "Input TF example files (can be a glob or comma separated).")

flags.DEFINE_string(
    "test_input_file", '../data/Amazon-sports/sportsdefault.test_p9.tfrecord',
    "Input TF example files (can be a glob or comma separated).")

flags.DEFINE_string("checkpointDir", 'checkpoint/sports_learning_finetune_p9/',
                    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string("vocab_filename", '../data/Amazon-sports/sportsdefault.vocab_p9', "vocab filename")

flags.DEFINE_string("user_history_filename", '../data/Amazon-sports/sportsdefault.his_p9', "user history filename")

## Other parameters
flags.DEFINE_string("init_checkpoint", 'checkpoint/sports_learning_pretrain_p9/model.ckpt-200000', "Initial checkpoint.") #

flags.DEFINE_integer("max_seq_length", 50,
                     "The maximum total input sequence length after WordPiece tokenization. "
                     "Sequences longer than this will be truncated, and sequences shorter "
                     "than this will be padded. Must match data generation.")
flags.DEFINE_integer("preference_size", 9,
