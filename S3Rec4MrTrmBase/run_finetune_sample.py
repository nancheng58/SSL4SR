...
def main():
    ...
    parser.add_argument('--ckp', default=150, type=int, help="pretrain epochs 10, 20, 30...")
    ...
    # save model args
    args_str = f'{args.model_name}-{args.data_name}-{args.ckp}-3layer_05'
    ...
    if args.do_eval:
        ...
        pretrained_path = os.path.join(args.output_dir, f'{args.data_name}-epochs-{args.ckp}-3layer_05.pt')
        try:
