...
class Trainer:
    ...
    def get_sample_scores(self, epoch, pred_list):
        ...
        HIT_5, NDCG_5, MRR_5 = get_metric(pred_list, 5)
        HIT_10, NDCG_10, MRR_10 = get_metric(pred_list, 10)
        HIT_20, NDCG_20, MRR_20 = get_metric(pred_list, 20)
        post_fix = {
            "Epoch": epoch,
            "HIT@5": '{:.4f}'.format(HIT_5), "NDCG@5": '{:.4f}'.format(NDCG_5),
            "HIT@10": '{:.4f}'.format(HIT_10), "NDCG@10": '{:.4f}'.format(NDCG_10),
            "HIT@20": '{:.4f}'.format(HIT_20), "NDCG@20": '{:.4f}'.format(NDCG_20),
            "MRR@5": '{:.4f}'.format(MRR_5),"MRR@10": '{:.4f}'.format(MRR_10),
            "MRR@20": '{:.4f}'.format(MRR_20)
        }
        print(post_fix)
