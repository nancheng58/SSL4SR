...
def main():
    ...
    parser.add_argument("--sp_weight", type=float, default=0.1, help="sp loss weight")
    ...
    # save model args
    args_str = f'{args.model_name}-{args.data_name}-3layer_05sp'
    ...
    for epoch in range(args.pre_epochs):
        ...
        if (epoch+1) % 10 == 0:
            ckp = f'{args.data_name}-epochs-{epoch+1}-3layer_05.pt'
